    ...
    <div className="app">
      {showReadyScreen ? (
        <div className="ready-screen">
          <p style={{padding:'30px', fontFamily:'sans-serif'}}>⚠️ Atenção, ao clicar em concordo você assume por sua conta em risco as possíveis consequencias do mau uso desta aplicação</p>
